...
public class RunIterator implements Iterator {
  ...
  public int[] next() {
    ...
    // call to next() will return the subsequent run.
	  ...
	  pixels[0] = (int) curNode.runL;
	  pixels[1] = (int) curNode.R;
	  pixels[2] = (int) curNode.G;
	  pixels[3] = (int) curNode.B;
